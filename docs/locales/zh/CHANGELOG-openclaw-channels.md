...
实现了基于 EventBridge 的双向通信系统，支持执行引擎与 channel 插件（包括 WebUI 聊天框和 OpenClaw 飞书插件形态）的消息交互。
...
- Channel 配置示例
- EventBridge API、WebUI Channel、OpenClaw 适配、飞书接口清单、集成测试等文档

**文件：**

- `config/channels.example.json`
- 中文文档见本目录：[event-bridge-api.md](./event-bridge-api.md)、[webui-channel.md](./webui-channel.md)、[openclaw-adapter.md](./openclaw-adapter.md)、[feishu-interfaces.md](./feishu-interfaces.md)、[integration-testing.md](./integration-testing.md)
